...
public sealed class ExceptionHandlingMiddleware
{
    ...
    private static (int StatusCode, string Title, string ErrorCode) MapException(Exception exception) =>
        exception switch
        {
            ...
            IdempotencyConflictException => (StatusCodes.Status409Conflict, exception.Message, "IdempotencyConflict"),
            IdempotencyInProgressException => (StatusCodes.Status409Conflict, exception.Message, "IdempotencyInProgress"),
            IdempotencyKeyRequiredException => (StatusCodes.Status400BadRequest, exception.Message, "IdempotencyKeyRequired"),
